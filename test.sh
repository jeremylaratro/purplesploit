...
show_menu() {
    ...
    local header="Creds: $CURRENT_CRED_NAME | Target: ${CURRENT_TARGET_NAME:-<none>} | Mode: $run_mode_text"
...
Manage Credentials
Manage Targets
Exit" | fzf --prompt="$prompt" --height=100% --reverse --header="$header"
            ;;
        "feroxbuster")
...
main_menu() {
    while true; do
        ...
        choice=$(show_menu "main" "Select Category: ")
