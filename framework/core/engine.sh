...
framework_help() {
    ...
    echo "================================================================================"
    echo ""
    echo "Quick Keybinds (single letters):"
    echo "  s                         - Switch/select target (interactive)"
    echo "  c                         - Credentials menu (interactive)"
    echo "  t                         - Show target management help"
    echo "  a                         - Apply/activate credentials"
    echo "  v                         - Variable editor (interactive)"
    echo ""
    echo "================================================================================"
    echo ""
    echo "Tips:"
    echo "  🔍 = FZF enhanced - interactive menu-driven interface"
    echo "  ⚡ = Quick keybind - single letter shortcuts for common tasks"
...
framework_quickstart() {
    ...
    echo -e "   ${GREEN}search nmap${NC}"
    echo ""
    echo "2. Select a module:"
    echo -e "   ${GREEN}use recon/nmap/quick_scan${NC}"
    echo ""
    echo "3. View module options:"
    echo -e "   ${GREEN}show options${NC}"
    echo ""
    echo "4. Set required variables:"
    echo -e "   ${GREEN}set RHOST 192.168.1.1${NC}"
    echo ""
    ...
    echo "================================================================================"
    echo ""
    echo -e "Type '${GREEN}help${NC}' for full command list"
    echo ""
}
